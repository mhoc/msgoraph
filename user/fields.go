...
var (
	// AllFields specifies every user field available for selection in api calls.
	AllFields = []Field{
		FieldID,
		FieldAboutMe,
		FieldAccountEnabled,
	...
	// DefaultFields specifies the Microsoft-specified default fields available for selection
	// in API calls.
	DefaultFields = []Field{
		FieldAccountEnabled,
		FieldBusinessPhones,
